...
namespace 草堂街道社会智能数据管理系统.Excel
{
    class ExportExcel
    {
        ...
        public void WriteData(string[,] data, int startRow, int startColumn)
        {
            ...
            for (int i = 0; i < rowNumber; i++)
            {
                ...
                {
                    //在Excel中，如果某单元格以单引号“'”开头，表示该单元格为纯文本，因此，我们在
        ...
        {
            Range range = myExcel.get_Range(myExcel.Cells[row, column], myExcel.Cells[row,
           column]);
        ...
        public void CreateWorkSheet(string sheetName)
        {
           ...
           (Worksheet)myWorkBook.Worksheets.Add(Type.Missing, Type.Missing, Type.Missing,
           Type.Missing);
        ...
        {
            Range range = myExcel.get_Range(myExcel.Cells[startRow, startColumn],
        ...
        public void CellsAlignment(int startRow, int startColumn, int endRow, int endColumn,
       ExcelHAlign hAlign, ExcelVAlign vAlign)
        {
            Range range = myExcel.get_Range(myExcel.Cells[startRow, startColumn],
           myExcel.Cells[endRow, endColumn]);
        ...
        public void CellsBackColor(int startRow, int startColumn, int endRow, int endColumn,
       ColorIndex color)
        {
            Range range = myExcel.get_Range(myExcel.Cells[startRow, startColumn],
           myExcel.Cells[endRow, endColumn]);
        ...
        public void CellsBackColor(int startRow, int startColumn, int endRow, int endColumn,
       ColorIndex color, Pattern pattern)
        {
            Range range = myExcel.get_Range(myExcel.Cells[startRow, startColumn],
           myExcel.Cells[endRow, endColumn]);
            range.Interior.ColorIndex = color;
        ...
        public void SetRowHeight(int startRow, int endRow, int height)
        {
            //获取当前正在使用的工作表
            Worksheet worksheet = (Worksheet)myExcel.ActiveSheet;
            Range range = (Range)worksheet.Rows[startRow.ToString() + ":" +
           endRow.ToString(), System.Type.Missing];
        ...
        public void RowAutoFit(int rowNum)
        {
            //获取当前正在使用的工作表
            Worksheet worksheet = (Worksheet)myExcel.ActiveSheet;
            Range range = (Range)worksheet.Rows[rowNum.ToString() + ":" +
           rowNum.ToString(), System.Type.Missing];
        ...
        public void SetColumnWidth(string startColumn, string endColumn, int width)
        {
            //获取当前正在使用的工作表
            Worksheet worksheet = (Worksheet)myExcel.ActiveSheet;
            Range range = (Range)worksheet.Columns[startColumn + ":" + endColumn,
           System.Type.Missing];
        ...
        public void SetColumnWidth(int startColumn, int endColumn, int width)
        {
            ...
            //获取当前正在使用的工作表
            Worksheet worksheet = (Worksheet)myExcel.ActiveSheet;
            Range range = (Range)worksheet.Columns[strStartColumn + ":" + strEndColumn,
           System.Type.Missing];
            range.ColumnWidth = width;
        }
        /// <summary>
        ...
        public void ColumnAutoFit(string column)
        {
            //获取当前正在使用的工作表
            Worksheet worksheet = (Worksheet)myExcel.ActiveSheet;
            Range range = (Range)worksheet.Columns[column + ":" + column,
           System.Type.Missing];
            range.EntireColumn.AutoFit();
        }
        ...
        public void ColumnAutoFit(int columnNum)
        {
            ...
            //获取当前正在使用的工作表
            Worksheet worksheet = (Worksheet)myExcel.ActiveSheet;
            Range range = (Range)worksheet.Columns[strcolumnNum + ":" + strcolumnNum,
           System.Type.Missing];
            range.EntireColumn.AutoFit();
        ...
        /// <param name="endColumn">结束列</param>
        /// <param name="color">颜色索引</param> 
        public void FontColor(int startRow, int startColumn, int endRow, int endColumn, ColorIndex
       color)
        {
            Range range = myExcel.get_Range(myExcel.Cells[startRow, startColumn],
           myExcel.Cells[endRow, endColumn]);
        ...
        public void FontStyle(int startRow, int startColumn, int endRow, int endColumn, bool isBold,
       bool isItalic, UnderlineStyle underline)
        {
            Range range = myExcel.get_Range(myExcel.Cells[startRow, startColumn],
           myExcel.Cells[endRow, endColumn]);
        ...
        public void FontNameSize(int startRow, int startColumn, int endRow, int endColumn, string
